...
INSERT INTO `USER` VALUES ('1', 'admin', '14e1b600b1fd579f47433b88e8d85291', 
	'初始化管理员','我是管理员','自我介绍', 'SUPERADMIN','SCORI', 'admin@email.com',NULL,NULL, '/resource/images/deault_head.png', '0', NOW(),NULL,NULL);
...
(
	...
	`JOINTIME` VARCHAR(32) NOT NULL COMMENT '加入的时间',
	`COMMENT` TEXT COMMENT '备注',
	PRIMARY KEY  (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8;

DROP TABLE IF EXISTS `COURSE_ESTIMATE`;
CREATE TABLE `COURSE_ESTIMATE`
(
	 `ID` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '评论的ID',
	 `COURSEID` INT(10) NOT NULL COMMENT '所属课程ID',
	 `USERID` INT(11) UNSIGNED NOT NULL COMMENT '用户ID',
	 `GRADE` INT(5) DEFAULT 0 COMMENT '评价的级别(共分5个级别)',
	 `CREATETIME` VARCHAR(32) NOT NULL COMMENT '评价的时间',
